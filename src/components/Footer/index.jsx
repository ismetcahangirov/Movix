...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-6">
      <div className="container mx-auto w-full max-w-[1280px] px-4  flex flex-col md:flex-row items-center  md:items-start justify-between flex-wrap gap-4">
        ...
        <div className="flex flex-col items-center md:items-start justify-between gap-2">
          ...
          <div className="flex flex-col items-center md:items-start gap-2 text-sm text-center w-full sm:w-auto">
            <a
